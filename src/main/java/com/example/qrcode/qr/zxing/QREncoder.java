...
public final class QREncoder {
	...
	public static QRCode encode(String content, ErrorCorrectionLevel ecLevel, 
		...
		return encode(content, ecLevel, null, positionals);
	}
	...
	public static QRCode encode(String content,
		...
		MatrixUtil.buildMatrix(finalBits, ecLevel, version, maskPattern, matrix, positionals);
	...
	private static int chooseMaskPattern(BitArray bits,
		...
		for (int maskPattern = 0; maskPattern < QRCode.NUM_MASK_PATTERNS; maskPattern++) {
			MatrixUtil.buildMatrix(bits, ecLevel, version, maskPattern, matrix, new ArrayList<>());
